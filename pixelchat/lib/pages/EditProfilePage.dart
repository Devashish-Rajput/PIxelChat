...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  updateUserData(){
    setState(() {
      ...
      bioTextEditingController.text.trim().length>110 ? _bioNameValid=false: _bioNameValid=true;
    });
    
    if(_bioNameValid && _profileNameValid) {
      ...
      children: <Widget>[
        ...
        TextField(
          ...
          decoration: InputDecoration(
            hintText: "Write a profile name here...",
      ...
      children: <Widget>[
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: TextStyle(color: Colors.grey),
            errorText: _bioNameValid? null: "Bio is very short",
          ),
        ),
      ],
    );
